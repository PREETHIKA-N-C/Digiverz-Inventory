...
import PipelineComp from "../Components/PipelineComp";
import PipelineSkullLoader from "../Components/PipelineSkullLoader";
    ...
    <>
      {load ? (
        ...
        <PipelineSkullLoader
          bgColor="#abe6e3"
          borderColor=""
          loadAnimation="skull-Load-Light"
        />
      ) : (
        <PipelineSkullLoader
          bgColor="#2c36395f"
          loadAnimation="skull-Load"
          borderColor="#303030"
        />
      )}
    </>
...
// import "../Components/PipelinePage.module.css";
