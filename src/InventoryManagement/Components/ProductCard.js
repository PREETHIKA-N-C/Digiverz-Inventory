...
function ProductCard({name="Sentiment Analysis",desc="Accelerator | Productivity",logo="https://yt3.ggpht.com/ytc/AMLnZu_i0kljAsakXn2qz5sjtj7Tab-bmDtwDtBvM5t2aQ=s900-c-k-c0x00ffffff-no-rj",img="https://www.adobe.com/content/dam/www/us/en/max/2021/MAX2021-RegOpen-bnr-social-share-nodate-1200X630.jpg",url}) {
      ...
      <div className={theme === 'Light' ? Style.product_cont_Light : Style.product_cont}>  
       <div className={Style.product}>
         ...
         <div className={theme === 'Light' ? Style.product_details_Light:Style.product_details}>
            ...
            <a className={Style.get_btn} href={url}>LAUNCH</a>
            </div>
         </div>
       </div>
